USE Karify;
GO
IF EXISTS (SELECT * FROM sys.procedures WHERE name = 'sp_ObtenerDatosCorreoCotesistaRechazo') 
	BEGIN
		DROP PROCEDURE sp_ObtenerDatosCorreoCotesistaRechazo;
	END
GO

CREATE PROCEDURE sp_ObtenerDatosCorreoCotesistaRechazo
(
	@pidProyecto INT
)
AS
