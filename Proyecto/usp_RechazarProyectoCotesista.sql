USE Karify;
GO
IF EXISTS (SELECT * FROM sys.procedures WHERE name = 'usp_RechazarProyectoCotesista') 
	BEGIN
		DROP PROCEDURE usp_RechazarProyectoCotesista;
	END
GO

CREATE PROCEDURE usp_RechazarProyectoCotesista
(
	@pIdProyecto INT,
	@pIdUsuario INT,
